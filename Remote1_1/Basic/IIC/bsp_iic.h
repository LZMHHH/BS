...
/**************************I2C参数定义，I2C1或I2C2********************************/
//#define             SENSORS_I2C_APBxClock_FUN                   RCC_APB1PeriphClockCmd   //硬件
//#define             SENSORS_I2C_CLK                             RCC_APB1Periph_I2C1      //硬件
...
#define SDA_IN()  {GPIOB->CRL&=0X0FFFFFFF;GPIOB->CRL|=8<<(4*7);}
#define SDA_OUT() {GPIOB->CRL&=0X0FFFFFFF;GPIOB->CRL|=3<<(4*7);}
