...
/* ½Ó¿Ú */
uint8_t i2c_write(u8 devAddr,u8 regAddr, u16 length,u8* pData)
{
	I2C_WriteBytes( devAddr, regAddr, pData, length);
}
uint8_t i2c_read(u8 devAddr, u8 regAddr, u16 length, u8* pBuffer)
{
	I2C_ReadBytes(devAddr, regAddr, pBuffer, length);
}
